...
public class GridManager: MonoBehaviour
{
    ...
    public int gridWidthInHexes = 100;
    public int gridHeightInHexes = 100;
    ...
    Vector3 calcInitPos()
    {
		...
		initPos = new Vector3(Ground.transform.position.x - (groundWidth/2) + hexWidth/2, 0, Ground.transform.position.z + (groundHeight/2)-hexHeight/2);
    ...
    public void generateAndShowPath()
    {
        ...
        Path<Tile> path = PathFinder.FindPath(originTileTB.tile, destTileTB.tile);
        DrawPath(path);
    }
